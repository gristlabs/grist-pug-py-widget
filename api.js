...
var str = ρσ_str, repr = ρσ_repr;;
    ...
    (function(){
        ...
        var widget_id, _memory, lastListener;
        widget_id = new URLSearchParams(location.search).get("id") || crypto.randomUUID();
        function the() {
            var args = Array.prototype.slice.call(arguments, 0);
        ...
        if (!the.__handles_kwarg_interpolation__) Object.defineProperties(the, {
            __handles_kwarg_interpolation__ : {value: true},
            __module__ : {value: "__main__"}
        });
        ...
        if (!one.__handles_kwarg_interpolation__) Object.defineProperties(one, {
            __handles_kwarg_interpolation__ : {value: true},
            __module__ : {value: "__main__"}
        });
        ...
        if (!all.__handles_kwarg_interpolation__) Object.defineProperties(all, {
            __handles_kwarg_interpolation__ : {value: true},
            __module__ : {value: "__main__"}
        });
        ...
        if (!log.__handles_kwarg_interpolation__) Object.defineProperties(log, {
            __handles_kwarg_interpolation__ : {value: true},
            __module__ : {value: "__main__"}
        });
        ...
        function readfile(f) {
            ...
            request.send();
            if ((request.status === 200 || typeof request.status === "object" && ρσ_equals(request.status, 200))) {
                return request.responseText;
            }
        };
        if (!readfile.__argnames__) Object.defineProperties(readfile, {
            __argnames__ : {value: ["f"]},
            __module__ : {value: "__main__"}
        });
        ...
        CodeMirror.defaults.viewportMargin = 1e3;
        _memory = {};
        function memory(name) {
            var key;
            key = "__" + ρσ_str.format("{}", widget_id) + "_" + ρσ_str.format("{}", name) + "";
            try {
                if (_memory[(typeof key === "number" && key < 0) ? _memory.length + key : key]) {
                    return _memory[(typeof key === "number" && key < 0) ? _memory.length + key : key];
                }
            } catch (ρσ_Exception) {
                ρσ_last_exception = ρσ_Exception;
                if (ρσ_Exception instanceof KeyError) {
                } else {
                    throw ρσ_Exception;
                }
            }
            function fn() {
                var arg = (arguments[0] === undefined || ( 0 === arguments.length-1 && arguments[arguments.length-1] !== null && typeof arguments[arguments.length-1] === "object" && arguments[arguments.length-1] [ρσ_kwargs_symbol] === true)) ? fn.__defaults__.arg : arguments[0];
                var clear = (arguments[1] === undefined || ( 1 === arguments.length-1 && arguments[arguments.length-1] !== null && typeof arguments[arguments.length-1] === "object" && arguments[arguments.length-1] [ρσ_kwargs_symbol] === true)) ? fn.__defaults__.clear : arguments[1];
                var ρσ_kwargs_obj = arguments[arguments.length-1];
                if (ρσ_kwargs_obj === null || typeof ρσ_kwargs_obj !== "object" || ρσ_kwargs_obj [ρσ_kwargs_symbol] !== true) ρσ_kwargs_obj = {};
                if (Object.prototype.hasOwnProperty.call(ρσ_kwargs_obj, "arg")){
                    arg = ρσ_kwargs_obj.arg;
                }
                if (Object.prototype.hasOwnProperty.call(ρσ_kwargs_obj, "clear")){
                    clear = ρσ_kwargs_obj.clear;
                }
                var value;
                if (clear) {
            ...
            if (!fn.__defaults__) Object.defineProperties(fn, {
                __defaults__ : {value: {arg:null, clear:null}},
                __handles_kwarg_interpolation__ : {value: true},
                __argnames__ : {value: ["arg", "clear"]},
                __module__ : {value: "__main__"}
            });

            _memory[(typeof key === "number" && key < 0) ? _memory.length + key : key] = fn;
            return fn;
        };
        if (!memory.__argnames__) Object.defineProperties(memory, {
            __argnames__ : {value: ["name"]},
            __module__ : {value: "__main__"}
        });
        ...
        function changeEditor(el) {
            var target, tab, code;
            target = el.target;
            var ρσ_Iter0 = ρσ_Iterable(all(".tab"));
            for (var ρσ_Index0 = 0; ρσ_Index0 < ρσ_Iter0.length; ρσ_Index0++) {
                tab = ρσ_Iter0[ρσ_Index0];
                tab.style.background = "transparent";
            }
            target.style.background = "lightgreen";
            var ρσ_Iter1 = ρσ_Iterable(widget.codes);
            for (var ρσ_Index1 = 0; ρσ_Index1 < ρσ_Iter1.length; ρσ_Index1++) {
                code = ρσ_Iter1[ρσ_Index1];
                if ((code.tab === target.id || typeof code.tab === "object" && ρσ_equals(code.tab, target.id))) {
        ...
        if (!changeEditor.__argnames__) Object.defineProperties(changeEditor, {
            __argnames__ : {value: ["el"]},
            __module__ : {value: "__main__"}
        });

        function buildEditors(widget) {
            var editors, tabs, textarea, value, editor, tab, code;
            editors = the("editors");
            tabs = the("tabs");
            var ρσ_Iter2 = ρσ_Iterable(widget.codes);
            for (var ρσ_Index2 = 0; ρσ_Index2 < ρσ_Iter2.length; ρσ_Index2++) {
                code = ρσ_Iter2[ρσ_Index2];
                (ρσ_expr_temp = widget.codes)[ρσ_bound_index(code.name, ρσ_expr_temp)] = code;
                if ((code.name === widget.entrypoint || typeof code.name === "object" && ρσ_equals(code.name, widget.entrypoint))) {
                    widget.entrypoint = code;
                }
                textarea = document.createElement("textarea");
                textarea.id = "_" + ρσ_str.format("{}", code.name) + "";
                ...
                editor = CodeMirror.fromTextArea(textarea, (function(){
                    var ρσ_d = {};
                    ρσ_d["mode"] = (function(){
                        var ρσ_d = {};
                        ρσ_d["name"] = code.type;
                ...
                tab.id = "tab_" + ρσ_str.format("{}", code.name) + "";
        ...
        if (!buildEditors.__argnames__) Object.defineProperties(buildEditors, {
            __argnames__ : {value: ["widget"]},
            __module__ : {value: "__main__"}
        });

        function getcode(id) {
            return (ρσ_expr_temp = widget.codes)[(typeof id === "number" && id < 0) ? ρσ_expr_temp.length + id : id].editor.getValue();
        };
        if (!getcode.__argnames__) Object.defineProperties(getcode, {
            __argnames__ : {value: ["id"]},
            __module__ : {value: "__main__"}
        });

        lastListener = null;
        function new_iframe(el_id, htmlcode) {
            var el, wFrame, widgetWindow, content;
            el = the(el_id);
            ...
            if (!listener.__argnames__) Object.defineProperties(listener, {
        ...
        if (!new_iframe.__argnames__) Object.defineProperties(new_iframe, {
            __argnames__ : {value: ["el_id", "htmlcode"]},
            __module__ : {value: "__main__"}
        });
        ...
        function showPreview() {
            ...
            if ((code.type === "pug" || typeof code.type === "object" && ρσ_equals(code.type, "pug"))) {
                new_iframe("widget", pug.compile(code.editor.getValue())((function(){
                    var ρσ_d = {};
                    ρσ_d["grist"] = grist;
                    ρσ_d["cfg"] = cfg;
                    ρσ_d["getcode"] = getcode;
                    return ρσ_d;
                }).call(this)));
            ...
            } else if ((code.type === "javascript" || typeof code.type === "object" && ρσ_equals(code.type, "javascript"))) {
            ...
            var ρσ_Iter3 = ρσ_Iterable(ρσ_list_decorate([ ".tab", ".btn" ]));
            for (var ρσ_Index3 = 0; ρσ_Index3 < ρσ_Iter3.length; ρσ_Index3++) {
                cat = ρσ_Iter3[ρσ_Index3];
                var ρσ_Iter4 = ρσ_Iterable(all(cat));
                for (var ρσ_Index4 = 0; ρσ_Index4 < ρσ_Iter4.length; ρσ_Index4++) {
                    e = ρσ_Iter4[ρσ_Index4];
        ...
        if (!showPreview.__handles_kwarg_interpolation__) Object.defineProperties(showPreview, {
            __handles_kwarg_interpolation__ : {value: true},
            __module__ : {value: "__main__"}
        });
        ...
        function showEditor() {
            ...
            var ρσ_Iter5 = ρσ_Iterable(all(".tab"));
            for (var ρσ_Index5 = 0; ρσ_Index5 < ρσ_Iter5.length; ρσ_Index5++) {
                e = ρσ_Iter5[ρσ_Index5];
                e.style.display = "inline-block";
            }
            var ρσ_Iter6 = ρσ_Iterable(all(".btn"));
            for (var ρσ_Index6 = 0; ρσ_Index6 < ρσ_Iter6.length; ρσ_Index6++) {
                e = ρσ_Iter6[ρσ_Index6];
                e.style.display = "none";
            }
            the("install").style.display = "inline-block";
            the("preview").style.display = "inline-block";
        };
        if (!showEditor.__handles_kwarg_interpolation__) Object.defineProperties(showEditor, {
            __handles_kwarg_interpolation__ : {value: true},
            __module__ : {value: "__main__"}
        });

        function onOptions(clb) {
            var listen;
            listen = true;
            function callback() {
            ...
            if (!callback.__handles_kwarg_interpolation__) Object.defineProperties(callback, {
                __handles_kwarg_interpolation__ : {value: true},
                __module__ : {value: "__main__"}
            });
            ...
            if (!cancel.__module__) Object.defineProperties(cancel, {
                __module__ : {value: "__main__"}
            });
        ...
        if (!onOptions.__argnames__) Object.defineProperties(onOptions, {
            __argnames__ : {value: ["clb"]},
            __module__ : {value: "__main__"}
        });

        function callback() {
            var options = ( 0 === arguments.length-1 && arguments[arguments.length-1] !== null && typeof arguments[arguments.length-1] === "object" && arguments[arguments.length-1] [ρσ_kwargs_symbol] === true) ? undefined : arguments[0];
            var _args = Array.prototype.slice.call(arguments, 1);
            if (arguments[arguments.length-1] !== null && typeof arguments[arguments.length-1] === "object" && arguments[arguments.length-1] [ρσ_kwargs_symbol] === true) _args.pop();
            var code;
            try {
                if (widget.installed) {
                    return;
            ...
            if (options && options.installed) {
                ...
                var ρσ_Iter7 = ρσ_Iterable(widget.codes);
                for (var ρσ_Index7 = 0; ρσ_Index7 < ρσ_Iter7.length; ρσ_Index7++) {
                    code = ρσ_Iter7[ρσ_Index7];
                    memory(code.name)(options[ρσ_bound_index("_" + ρσ_str.format("{}", code.name) + "", options)]);
                }
                buildEditors(widget);
                showPreview();
                function cb() {
                ...
                if (!cb.__handles_kwarg_interpolation__) Object.defineProperties(cb, {
                    __handles_kwarg_interpolation__ : {value: true},
            ...
            if (!options) {
                var ρσ_Iter8 = ρσ_Iterable(widget.codes);
                for (var ρσ_Index8 = 0; ρσ_Index8 < ρσ_Iter8.length; ρσ_Index8++) {
                    code = ρσ_Iter8[ρσ_Index8];
                    (ρσ_expr_temp = memory(code.name), ρσ_interpolate_kwargs.call(ρσ_expr_temp, ρσ_expr_temp, [ρσ_desugar_kwargs({clear: true})]));
                }
            }
            if (!widget.isEditor) {
        ...
        function install() {
            ...
            var ρσ_Iter9 = ρσ_Iterable(widget.codes);
            for (var ρσ_Index9 = 0; ρσ_Index9 < ρσ_Iter9.length; ρσ_Index9++) {
                code = ρσ_Iter9[ρσ_Index9];
                options[ρσ_bound_index("_" + ρσ_str.format("{}", code.name) + "", options)] = code.editor.getValue();
            }
            grist.setOptions(options).then(window.location.reload());
        };
        if (!install.__handles_kwarg_interpolation__) Object.defineProperties(install, {
            __handles_kwarg_interpolation__ : {value: true},
            __module__ : {value: "__main__"}
        });
