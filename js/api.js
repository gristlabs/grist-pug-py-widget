// Transcrypt'ed from Python, 2023-11-20 17:57:07
...
export var showEditOptions = function (options) {
	memory ('preview') (false);
	if (options) {
		for (var _id in models) {
			memory (_id) (options ['_{}'.format (_id)]);
		}
	}
	return showEditor ();
};
export var onEditOptions = function () {
	var args = tuple ([].slice.apply (arguments).slice (0));
